...
Учусь и практикую в тестирование с **июля 2025 года**. Филологическое образование (с отличием, красный диплом). Специализация — отечественная лингвистика, анализ текста и языковых систем.
